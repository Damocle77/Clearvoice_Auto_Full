...
# Batch per lanciare clearvoice_auto_full.sh su multipli MKV nella cartella corrente.
...
mapfile -t mkv_files < <(find . -maxdepth 1 -type f -name "*.mkv" ! -name "*_clearvoice_auto.*" -print0 | sort -zV | tr '\0' '\n')
